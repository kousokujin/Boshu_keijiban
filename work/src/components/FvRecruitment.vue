  ...
  <table class="table table-striped mb-3">
    ...
    <tbody>
      <tr v-for="m in main_data.members" v-bind:key="m.id">
        ...
        <td>
          <button v-if="m.isEdit == false" type="btn" class="btn btn-sm btn-primary" v-on:click="edit_member_btn(m.id)"><i class="bi bi-pencil-square"></i></button>
          <button v-else type="btn" class="btn btn-sm btn-success" v-on:click="apply_member_btn(m.id)"><i class="bi bi-check-lg"></i></button>
        </td>
      </tr>
